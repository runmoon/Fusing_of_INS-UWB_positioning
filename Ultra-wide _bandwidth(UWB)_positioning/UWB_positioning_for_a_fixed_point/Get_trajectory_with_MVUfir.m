% 1.滤波效果受horizon的取值和Q、P的取值影响很大
% 2.当horizon与Q、P没有取相互对应的值时，滤波效果会偏很坏
% 3.当horizon取18，Q = [1e-5 0 0 0;0 1e-5 0 0;0 0 1e-5 0;0 0 0 1e-5]，R = [0.97 0;0 0.97]
%    时，会有还不错的效果，但还逊色于卡尔曼滤波器
% 4.噪声选取过大时，受前N个采样点的末端的点的方向影响很大？？！！
% 5.速度，预测没加入？？！！
...
fid = fopen('2018-8-28-12-4-46.txt');
